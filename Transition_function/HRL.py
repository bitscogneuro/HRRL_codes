...
def parseArgs(argv):
    ...
    parser.add_argument('--num_iter', type=int, default=5500,
    ...
    parser.add_argument('--freq_plot', type=int, default=5500,
                        help='Make one plot every freq_plot steps.')


    parser.add_argument('--freq_save_weights', type=int, default=5500,
...
def main(argv):
    ...
    #     '/Users/ibrain/Downloads/Cognitive Neuroscience Work/boris gutkin/Netf/Transition_function/weights/weights_net_f',
