...
class Algorithm:
    ...
    def simulation_one_step(self, k: int):
        ...
        self.resource_availability.append(is_available)
        if is_available:
    ...
    def simulation(self):
        ...
        for k in range(self.hp.cst_algo.N_iter):
            ...
            df8 = pandas.DataFrame(self.resource_availability, columns=['resource_available'])
            combined_df2 = pandas.concat([df2, df1, df3, df4, df5, df6, df7, df8], axis=1)
            combined_df2.to_csv(
                f"/Users/ibrain/Downloads/Cognitive Neuroscience Work/boris gutkin/Dec 2025 Revision/Probability Plots/greedy_prob.csv")
