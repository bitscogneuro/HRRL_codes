...
class Algorithm:
    ...
    def simulation_one_step(self, k: int):
        ...
        if action == 6:
            if not is_available:
                print(f"Action = {action} and resource is not available {is_available}")
    ...
    def simulation(self):
        ...
        for k in range(self.hp.cst_algo.N_iter):
            ...
            combined_df2.to_csv(
                f"/Users/ibrain/Downloads/Cognitive Neuroscience Work/boris gutkin/Dec 2025 Revision/Probability Plots/random_prob.csv")
