...
class Cst_env:
    def __init__(self, difficulty: Difficulty):
        ...
        two_resources: List[ResourceDC] = [
            ResourceDC(x=1.0, y=4.25, r=0.3, color='red'),
            ResourceDC(x=3.5, y=2.0, r=0.3, color='blue'),

            # ResourceDC(x=1, y=9, r=0.3, color='red'),
            # ResourceDC(x=9, y=9, r=0.3, color='blue'),
            #
            # Location 2
            # ResourceDC(x=5, y=9, r=0.3, color='red'),
            # ResourceDC(x=9, y=1, r=0.3, color='blue'),
            #
            # Location 3
            # ResourceDC(x=1, y=6, r=0.3, color='red'),
            # ResourceDC(x=1, y=9, r=0.3, color='blue'),
            #
            # Location 4
            # ResourceDC(x=2, y=7, r=0.3, color='red'),
            # ResourceDC(x=8, y=1, r=0.3, color='blue'),

            # ResourceDC(x=1, y=8, r=0.3, color='red'),
            # ResourceDC(x=8, y=9, r=0.3, color='blue'),
        ]
...
class Cst_agent:
    def __init__(self, difficulty: Difficulty):
        ...
        val_x_star = {}
        for i in range(difficulty.n_resources):
            val_x_star[f"resource_{i}"] = i+1 #i + 1  # homeostasis set point set up
...
class Cst_actions:
    def __init__(self, difficulty: Difficulty, cst_agent: Cst_agent):
        ...
        # self.consumption_resource = 0.2

        self.consumption_resource = 0.1

        self.default_action = "doing_nothing"

        self.coefficient_loss_small_action = 100
        self.coefficient_loss_big_action = 1
